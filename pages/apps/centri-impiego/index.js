...
function getLayer(id, legendLabel) {
  ...
  return {
    ...
    visible: true,
    geomSubType: 'POINT',
    url: `/geoservices/data/centri-impiego/${id}.json`,
    legend: {
      label: legendLabel,
