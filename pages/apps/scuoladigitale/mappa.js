      ...
      layers: [
        {
          ...
          visible: true,
          geomSubType: 'POINT',
          url: 'http://srvcarto.regione.liguria.it/geoviewer2/data/scuoladigitale/scuole01.json',
          legend: {
        ...
        },
        {
          ...
          visible: true,
          geomSubType: 'POINT',
          url: 'http://srvcarto.regione.liguria.it/geoviewer2/data/scuoladigitale/scuole02.json',
          legend: {
        ...
        },
        {
          ...
          visible: true,
          geomSubType: 'POINT',
          url: 'http://srvcarto.regione.liguria.it/geoviewer2/data/scuoladigitale/scuole03.json',
          legend: {
        ...
        },
        {
          ...
          visible: true,
          geomSubType: 'POINT',
          url: 'http://srvcarto.regione.liguria.it/geoviewer2/data/scuoladigitale/scuole04.json',
          legend: {
        ...
        },
        {
          ...
          visible: true,
          geomSubType: 'POINT',
          url: 'http://srvcarto.regione.liguria.it/geoviewer2/data/scuoladigitale/scuole06.json',
          legend: {
          ...
          classes: [
            {
              ...
              style: {
                iconUrl: '/geoviewer2/static/img/scuoladigitale/legend/school06.jpg',
                iconSize: [32, 37],
                iconAnchor: [16, 37],
                popupAnchor: [0, -37],
              },
        ...
        },
        {
          ...
          visible: true,
          geomSubType: 'POINT',
          url: 'http://srvcarto.regione.liguria.it/geoviewer2/data/scuoladigitale/scuole07.json',
          legend: {
          ...
          classes: [
            {
              ...
              style: {
                iconUrl: '/geoviewer2/static/img/scuoladigitale/legend/school07.png',
                iconSize: [32, 37],
                iconAnchor: [16, 37],
                popupAnchor: [0, -37],
              },
