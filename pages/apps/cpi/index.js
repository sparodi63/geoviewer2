...
const svg_ente = `<svg class="svg-icon v-align" viewBox="0 0 42.32 60.38">
...
const svg_indirizzo = `<svg class="svg-icon v-align" viewBox="0 0 59.38 52.49">
  <g id="Livello_2" data-name="Livello 2">
    <g id="Livello_1-2" data-name="Livello 1">
...
const svg_mail = `<svg class="svg-icon v-align" viewBox="0 0 44.76 46.74">
  <g id="Livello_2" data-name="Livello 2">
    <g id="Livello_1-2" data-name="Livello 1">
      <g>
...
const template = `
  <div class="div-popup div-cpi">
  ${svg_ente}<span class="v-align" >{NOME_SEDE}</span><br>
  ${svg_indirizzo}<span class="v-align" >{INDIRIZZO} {CIVICO}, {CAP} {COMUNE}</span><br>
  <div id="popup-header" ><b><a href="javascript:GV.prenota({ID})" >PRENOTA <span class="fa fa-angle-right"></span></a></b>
  </div>
`
...
const layers = [{
    ...
    visible: true,
    geomSubType: 'POINT',
    url: `/geoservices/data/centri-impiego/cpi.json`,
    tooltip: '{NOME_SEDE}',
    ...
    classes: [
      {
        filter: filter,
        style: {
          iconUrl: `/geoservices/apps/viewer/static/img/centri-impiego/legend/cpi.png`,
          iconSize: [20, 29],
          iconAnchor: [14, 29],
          popupAnchor: [0, -29],
        },
