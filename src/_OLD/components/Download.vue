    ...
    <div class="gv-map-download-body" id="gv-map-download-body">
      <el-form :model="form" ref="form">
        ...
        <el-form-item>
          ...
          <el-input id="gv-map-download-email" style="width: 250px;" size="mini" placeholder="Email" type="email" v-model="codCliente">
          </el-input>
        </el-form-item>
        <el-form-item>
          <span v-if="showSelectLivelli" class="gv-map-download-label">Livello</span>
          <el-select id="gv-map-download-livello" v-if="showSelectLivelli" v-model="livello" size="mini" placeholder="Scegli un livello">
        ...
        <el-form-item>
          ...
          <el-select id="gv-map-download-temi" v-if="config.flagDownloadPerTemi" v-model="codTema" size="mini" placeholder="Tutti i tematismi">
        ...
        <el-form-item>
          ...
          <el-select id="gv-map-download-formato" v-model="formato" size="mini" @change="changeFormat">
        ...
        <el-form-item>
          ...
          <el-select id="gv-map-download-selterr" v-model="selezioneTerritoriale" size="mini" @change="changeSelezioneTerritoriale">
        ...
        <el-form-item>
          ...
          <el-select id="gv-map-download-comuni" v-show="showSelectComuni" v-model="comune" size="mini" filterable>
        ...
        <el-form-item>
          ...
          <el-select id="gv-map-download-fogli" v-show="showSelectFogli" v-model="fogli" size="mini" multiple collapse-tags >
        ...
        <el-form-item>
          ...
          <el-select id="gv-map-download-macrobacini" v-show="showSelectMacrobacini" v-model="macrobacino" size="mini" filterable >
              <el-option v-for="item in macrobacini" :key="item.codice"  :value="item.codice" :label="item.nome" >
              </el-option>
          </el-select>
        </el-form-item>
        <el-form-item>
          <el-button id="gv-map-download-rect-reset" v-show="showRectReset" type="primary" size="mini" @click="rectReset">Reimposta Rettangolo</el-button>
        </el-form-item>

        <el-form-item class="gv-map-download-buttons">
          <img src="https://srvcarto.regione.liguria.it/geoviewer2/static/img/cc-by.png" align="bottom" onclick="javascript:window.open('https://creativecommons.org/licenses/by/3.0/deed.it')">
  ...
  methods: {
    ...
    addLayerSquadri() {
      ...
      if (selFogli) {
        ...
        const baseUrl = `http://geoservizi.regione.liguria.it/geoserver/wfs?service=WFS&version=2.0.0&request=GetFeature&srsName=EPSG:4326&outputFormat=application%2Fjson&typeName=`
