<template>
  <div  class="gv-map-selezione-fogli gv-inverted-color-scheme" id="gv-map-selezione-fogli">
    ...
    <div class="gv-map-selezione-fogli-body" id="gv-map-selezione-fogli-body">
          ...
          <el-button id="gv-map-selezione-fogli-submit" type="primary" size="mini" @click="submit">Conferma</el-button>
          <el-button id="gv-map-selezione-fogli-cancel" type="primary" size="mini" @click="cancel">Annulla</el-button>
          </div>
      </el-form>
    </div>
  </div>
