;(function (factory) {
  ...
  L.Control.Search = L.Control.extend({
    ...
    options: {
      ...
      textCancel: 'Annulla Ricerca...',		    //title in cancel button
...
//	in this mode every record can have a free structure of attributes, only 'loc' is required
    ...
    onAdd: function (map) {
      ...
      this._cancel = this._createCancel(this.options.textCancel, 'search-cancel fa fa-times');
...
//////end DOM creations
    ...
    _recordsFromLayer: function () {	//return table: key,value from layer
      ...
      this._layer.eachLayer(function (layer) {
          if (layer.hasOwnProperty('_isMarkerSearch')) {
              return;
          }
