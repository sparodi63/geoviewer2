...
GV.init({
  ...
  maps: [{
    ...
    layers: [{
      ...
      visible: true,
      geomSubType: 'POINT',
      url: 'http://srvcarto.regione.liguria.it/geoviewer2/data/scuoladigitale/01.json',
      legend: {
    ...
    },
      {
        ...
        visible: true,
        geomSubType: 'POINT',
        url: 'http://srvcarto.regione.liguria.it/geoviewer2/data/scuoladigitale/02.json',
        legend: {
      ...
      },
      {
        ...
        visible: true,
        geomSubType: 'POINT',
        url: 'http://srvcarto.regione.liguria.it/geoviewer2/data/scuoladigitale/03.json',
        legend: {
      ...
      },
      {
        ...
        visible: true,
        geomSubType: 'POINT',
        url: 'http://srvcarto.regione.liguria.it/geoviewer2/data/scuoladigitale/04.json',
        legend: {
      ...
      },
      {
        ...
        visible: true,
        geomSubType: 'POINT',
        url: 'http://srvcarto.regione.liguria.it/geoviewer2/data/scuoladigitale/06.json',
        legend: {
